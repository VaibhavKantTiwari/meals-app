...
// }
// to fetch meal from the api of the meal app
async function fetchmealfromapi(url, val){
    const resp = await fetch(`${url+val}`);
    const meals = resp.json();
    return meals;
}
// this function will let us know about no of meal added in fava list
...
// to search the meal with the given name
function searchmeal(){
...
// to add or delete meal from fava meal list
...
// to show up the complete detail of the meal
